unit sdl;
{
  $Id: sdl.pas,v 1.40 2013/01/05 16:27:00 tb $
...
{
  $Log: sdl.pas,v $
  Revision 1.40  2013/01/05 16:27:00  tb
  Now compatible to Win64, using sdl64.dll, so this unit can used by 32 and 64 bit Compilers.
  Revision 1.39  2012/12/17 20:56:00  tb
  Changed PChar to PAnsiChar.
...
{$IFNDEF Has_UInt64}
  ...
  {$ELSE}
	...
	//i don't think so
	//but only delphi 3 and down need this so ;)
    PSInt64 = ^SInt64;
    SInt64 = record
      hi: UInt32;
      lo: UInt32;
